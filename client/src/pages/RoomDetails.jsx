      ...
      className='flex fle-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'>
            ...
            type="date" id='checkInDate' placeholder='Check-In' className='w-full rounded border boder-gray-300 px-3 py-2 mt-1.5 outline-none' required />
          </div>
          ...
          <div className='flex flex-col'>
            ...
            <input onChange={(e)=> setCheckOutDate(e.target.value)} min={checkInDate} disabled={!checkInDate}
             type="date" id='checkOutDate' placeholder='Check-Out' className='w-full rounded border boder-gray-300 px-3 py-2 mt-1.5 outline-none' required />
          </div>
          ...
          <div className='flex flex-col'>
            ...
            <input onChange={(e)=> setGuests(e.target.value)} value={guests} type="number" id='guests' placeholder='guests' className='max-w-20 rounded border boder-gray-300 px-3 py-2 mt:1.5 outline-none' required />
          </div>
